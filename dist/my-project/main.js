...
/* harmony import */ var _components_website_website_list_website_list_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/website/website-list/website-list.component */ "./src/app/components/website/website-list/website-list.component.ts");
...
/* harmony import */ var _components_page_page_list_page_list_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/page/page-list/page-list.component */ "./src/app/components/page/page-list/page-list.component.ts");
...
/* harmony import */ var _service_user_service_client__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./service/user.service.client */ "./src/app/service/user.service.client.ts");
/* harmony import */ var _service_website_service_client__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./service/website.service.client */ "./src/app/service/website.service.client.ts");
/* harmony import */ var _service_page_service_client__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./service/page.service.client */ "./src/app/service/page.service.client.ts");
/* harmony import */ var _service_widget_service_client__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./service/widget.service.client */ "./src/app/service/widget.service.client.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_website_website_new_website_new_component__WEBPACK_IMPORTED_MODULE_9__["WebsiteNewComponent"],
                _components_website_website_edit_website_edit_component__WEBPACK_IMPORTED_MODULE_10__["WebsiteEditComponent"],
                _components_website_website_list_website_list_component__WEBPACK_IMPORTED_MODULE_11__["WebsiteListComponent"],
                ...
                _components_page_page_list_page_list_component__WEBPACK_IMPORTED_MODULE_14__["PageListComponent"],
                ...
                _service_widget_service_client__WEBPACK_IMPORTED_MODULE_24__["SafePipe"]
            ],
            imports: [
            ...
            providers: [
                _service_user_service_client__WEBPACK_IMPORTED_MODULE_21__["UserService"],
                _service_website_service_client__WEBPACK_IMPORTED_MODULE_22__["WebsiteService"],
                _service_page_service_client__WEBPACK_IMPORTED_MODULE_23__["PageService"],
                _service_widget_service_client__WEBPACK_IMPORTED_MODULE_24__["WidgetService"]
            ],
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_user_service_client__WEBPACK_IMPORTED_MODULE_3__["UserService"],
...
var WebsiteEditComponent = /** @class */ (function () {
    ...
    WebsiteEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.websiteId = params['wid'];
            _this.website = _this.websiteService.findWebsitesById(_this.websiteId);
            _this.websites = _this.websiteService.findWebsitesByUser(_this.website.developerId);
        });
    };
...
var WebsiteListComponent = /** @class */ (function () {
    ...
    WebsiteListComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.developerId = params['userId'];
            _this.websites = _this.websiteService.findWebsitesByUser(_this.developerId);
        });
    };
...
var WidgetChooserComponent = /** @class */ (function () {
    ...
    WidgetChooserComponent.prototype.createWidget = function (type) {
        var widget = new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_3__["Widget"]((new Date()).getTime() + '', type, this.pageId, null, null, null, null);
...
var WidgetEditComponent = /** @class */ (function () {
    function WidgetEditComponent(route, router, widgetService) {
        this.route = route;
        this.router = router;
        this.widgetService = widgetService;
    }
...
var WebsiteService = /** @class */ (function () {
    function WebsiteService() {
        this.websites = [
            ...
            new _models_website_model_client__WEBPACK_IMPORTED_MODULE_1__["Website"]('234', 'Twitter', '456', 'Lorem'),
...
/*!**************************************************!*\
  !*** ./src/app/service/widget.service.client.ts ***!
  \**************************************************/
/*! exports provided: WidgetService, SafePipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var WidgetService = /** @class */ (function () {
    function WidgetService() {
        this.widgets = [
            WidgetService_1.newHeader('123', 'HEADING', '321', 2, 'GIZMODO'),
            WidgetService_1.newHeader('234', 'HEADING', '321', 4, 'Lorem ipsum'),
            WidgetService_1.newImage('345', 'IMAGE', '321', '100%', 'https://goo.gl/DoFdoq'),
            WidgetService_1.newHtml('456', 'HTML', '321', 'Lorem ipsum'),
            WidgetService_1.newHeader('567', 'HEADING', '321', 4, 'GIZMODE'),
            WidgetService_1.newYoutube('678', 'YOUTUBE', '321', '100%', 'https://www.youtube.com/embed/-deQurc3L-g'),
            WidgetService_1.newHtml('789', 'HTML', '321', 'Lorem ipsum')
        ];
    }
    WidgetService_1 = WidgetService;
    WidgetService.newHeader = function (id, widgetType, pageId, size, text) {
        return new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["Widget"](id, widgetType, pageId, size, text, null, null);
    };
    WidgetService.newHtml = function (id, widgetType, pageId, text) {
        return new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["Widget"](id, widgetType, pageId, null, text, null, null);
    };
    WidgetService.newImage = function (id, widgetType, pageId, width, url) {
        return new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["Widget"](id, widgetType, pageId, null, null, width, url);
    };
    WidgetService.newYoutube = function (id, widgetType, pageId, width, url) {
        return new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["Widget"](id, widgetType, pageId, null, null, width, url);
    };
    ...
    var WidgetService_1;
    WidgetService = WidgetService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
    ], WidgetService);
